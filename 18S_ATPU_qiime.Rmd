...
```
The observed number of features in the samples flattens off at a depth between 4000-6000 reads -> redo the rarefaction curve to focus on this region:
```
qiime diversity alpha-rarefaction \
    --i-table merged-collapsed-table_noBirdsMammals.qza \
    --m-metadata-file metadata.txt \
...
5500 sequences looks to be the sweet spot for capturing all the diversity -> rarefy all samples to this depth.
