...
2750 sequences looks to be sufficient for capturing all the diversity -> rarefy all samples to this depth.
...
```
This leaves 78 samples with a depth greater than 2750 - why has it gone down?